...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ImageView imageGrid = view.findViewById(R.id.item_img_grid);
        ImageView imageRemove = view.findViewById(R.id.item_img_remove);
        //加载图案
        if (i < mPathList.size()) {
            //+号前的图
            String imgUrl = mPathList.get(i);
            Glide.with(mContext).load(imgUrl).into(imageGrid);
            ...
            //加号
            imageGrid.setImageResource(R.drawable.ic_add_box_grey_400_48dp);
